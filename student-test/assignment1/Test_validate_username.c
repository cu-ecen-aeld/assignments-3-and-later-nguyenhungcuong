...
void test_validate_my_username()
{
    ...
    const char * my_user_name_in_conf_file = malloc_username_from_conf_file();

    TEST_ASSERT_EQUAL_STRING_MESSAGE(my_user_name, my_user_name_in_conf_file, "The username is different");
}
